...
export const ConfigSchema = StrictObject({
  ...
  network: StrictObject({
    ...
    audio_user_agent: Type.String({ minLength: 1, maxLength: 512 }),
...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  network: {
    ...
    audio_user_agent: 'Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.100 Safari/537.36',
    max_redirects: 5,
